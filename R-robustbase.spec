...
Version  : 0.99.1
Release  : 67
URL      : https://cran.r-project.org/src/contrib/robustbase_0.99-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/robustbase_0.99-1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701295498
